    ...
    <div className="max-w-4xl mx-auto p-6">
      ...
      <div className="bg-white rounded-lg p-6">
        ...
        <div className="mt-8 space-y-4 text-sm text-gray-600 border-t pt-4">
          <h4 className="font-semibold text-gray-700">Calculation Methodology</h4>
          
          <div className="space-y-2">
            <p><span className="font-medium">Base Costs:</span> Calculated using a combination of per-user licensing, integration complexity, data volume tiers, and support levels</p>
            
            <p><span className="font-medium">Monthly Growth:</span> Projects a 2% month-over-month increase in usage and associated costs based on typical enterprise adoption patterns</p>
            
            <p><span className="font-medium">Savings Estimation:</span> Calculated at 25% of total cost, derived from typical efficiency gains, reduced manual work, and automation benefits</p>
            
            <p><span className="font-medium">ROI Calculation:</span> Based on 3-year projection including implementation costs, maintenance, and projected efficiency gains</p>
          </div>
