    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gradient-to-r from-purple-600 to-blue-600 text-white py-12 px-6">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-4xl font-bold mb-4">Documentation Portal</h1>
          <p className="text-xl opacity-90">Build amazing customer experiences with our integration guides</p>
          ...
          <div className="mt-8 grid grid-cols-3 gap-6">
            <div className="bg-white/10 rounded-lg p-4 backdrop-blur-sm">
              ...
              <div className="text-2xl font-bold">{userProgress.earnedPoints} pts</div>
            </div>
            ...
            <div className="bg-white/10 rounded-lg p-4 backdrop-blur-sm">
              ...
              <div className="text-2xl font-bold">{userProgress.completedTutorials}</div>
            </div>
          </div>
        </div>
      </div>
